...
{
    [Table("LugaresInstituciones")]
    public class LugarInstitucion
    {
        public LugarInstitucion()
        {
            Servidores = new ObservableCollection<ServidorPublico>();
        }
        [StringLength(20)]
        public string LugarInstitucionId { get; set; }//                         1 Identificador único del registro, número consecutivo
        [StringLength(20)]
