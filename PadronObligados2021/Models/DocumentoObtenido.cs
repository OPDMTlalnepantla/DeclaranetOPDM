...
{
    [Table("DocumentosObtenidos")]
    public class DocumentoObtenido
    {
        public DocumentoObtenido()
        {
            Servidores = new ObservableCollection<ServidorPublico>();
        }
        [StringLength(11)]
        public string DocumentoObtenidoId { get; set; }//                         1 Identificador único del registro, número consecutivo
        [StringLength(20)]
