...
namespace PadronObligados2021.Models
{
    ...
    public class ServidorPublico
    {
        ...
        [Required,Display(Name = "Correo electrónico Personal*:"), StringLength(100)]
        ...
        [Required, Display(Name = "Municipio*:")]
        ...
        [Required, Display(Name = "Localidad o colonia*:"), StringLength(50)]
        ...
        [Required, Display(Name = "Estado civil*:"), StringLength(3)]
        ...
        [Display(Name = "Número identificación oficial(INE):"), StringLength(50)]
        ...
        [Required, Display(Name = "Serv. púb. obligado año anterior*?:"), StringLength(2)]
        ...
        [Required,Display(Name = "Grado maximo de estudios*:"), StringLength(3)]
        ...
        [Required, Display(Name = "Institución Educativa*:"), StringLength(200)]
        ...
        [Required, Display(Name = "Carrera o área de conoc.*:"), StringLength(150)]
        public string CarreraArea { get; set; }//                            8 Carrera o área de conocimiento  carrera o área de conocimiento Texto, 150 caracteres
        [Required, Display(Name = "Estatus*:"), StringLength(10)]
        public string EstatusNivelEscolaridadId { get; set; }//                9 Estatus Estatus del nivel escolar(CURSANDO / TRUNCO / FINALIZADO)  Texto, 10 caracteres
        [Required, Display(Name = "Documento obtenido*:"), StringLength(11)]
        public string DocumentoObtenidoId { get; set; }//                     10 Documento obtenido Descripción del documento obtenido(BOLETA / CERTIFICADO / CONSTANCIA / TITULO) Texto, 11 caracteres
        [Required, Display(Name = "Fecha obtención*:"), DataType(DataType.Date)]
        ...
        [Required, Display(Name = "Lugar ubicación institución*:"), StringLength(16)]
        public string LugarInstitucionId { get; set; }//                      12 Lugar donde se ubica la institución educativa   Lugar donde se ubica la institución educativa(MÉXICO / EN EL EXTRANJERO)  Texto, 16 caracteres
        ...
        [StringLength(17)]
        [Display(Name = "Sector:")]
        public string AmbitoId { get; set; }//                    5 Ámbito o sector en el que laboraste     PUBLICO / PRIVADO / OTRO Texto, 7 caracteres
        //                                                                   6 Describa el otro ámbito o sector laboral        Texto, 50 caracteres
        [StringLength(20)]
        [Display(Name = "Ambito:")]
        public string NivelId { get; set; }//                                  7 Nivel / Orden de gobierno FEDERAL / ESTATAL / MUNICIPAL O ALCALDIA Texto, 20 caracteres
        [StringLength(17)]
        [Display(Name = "Poder:")]
        public string AmbitoPublicoId { get; set; }//                          8 Ambito público EJECUTIVO / LEGISLATIVO / JUDICIAL / ORGANO AUTONOMO    Texto, 17 caracteres
        [StringLength(100)]
        ...
        public EstatusNivelEscolaridad EstatusNivelEscolaridad { get; set; }
        public DocumentoObtenido DocumentoObtenido { get; set; }
        public LugarInstitucion LugarInstitucion { get; set; }
    }
}
